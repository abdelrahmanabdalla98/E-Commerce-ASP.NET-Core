! function(e) {
    ...
    if (e(window).on("load", (function() {
        ...
        }, e(".th-menu-wrapper2").thmobilemenu(), t(".onepage-nav"), t(".scroll-down"), e(window).scroll((function() {
    ...
    if (e("[data-bg-src]").length > 0 && e("[data-bg-src]").each((function() {
        ...
        var o, r = {
            ...
            on: {
                init: function() {
                    let t = this;
                    for (let n = 0; n < t.slides.length; n++) e(t.slides[n]).find(".hero-img").attr({
                        "data-swiper-parallax": .75 * t.width,
                        "data-swiper-parallax-opacity": .5
                    }), e(t.slides[n]).find(".title").attr("data-swiper-parallax", .65 * t.width), e(t.slides[n]).find(".description").attr("data-swiper-parallax", .5 * t.width)
                },
                resize: function() {
                    this.update()
                }
        ...
        o = new Swiper(".parallax-slider", r), e(window).on("resize", (function() {
    ...
    e.fn.activateSliderThumbs = function(t) {
        ...
        return this.each((function() {
            ...
            if (a.on("click", (function(t) {
                    t.preventDefault();
                    var a = e(this);
                    if (a.addClass("active").siblings().removeClass("active"), c(a), a.prevAll(n.tabButton).addClass("list-active"), a.nextAll(n.tabButton).removeClass("list-active"), n.sliderTab) {
                        var s = a.index();
                        o.slideTo(s)
                    }
                })), n.sliderTab) {
                o.on("slideChange", (function() {
                    var e = o.realIndex,
                        t = a.eq(e);
                    t.addClass("active").siblings().removeClass("active"), c(t), t.prevAll(n.tabButton).addClass("list-active"), t.nextAll(n.tabButton).removeClass("list-active")
                }));
                var r = o.activeIndex,
                    l = a.eq(r);
                l.addClass("active").siblings().removeClass("active"), c(l), l.prevAll(n.tabButton).addClass("list-active"), l.nextAll(n.tabButton).removeClass("list-active")
            }
    ...
    e((function() {
        e(".top-search form.header-search .box-search").each((function() {
            ...
            e(t.target).closest(".box-search").length || (e(".top-search .box-search .overlay").css({
                opacity: "0",
                display: "none"
    ...
    if (e(c).on("submit", (function(e) {
            e.preventDefault(), p()
        })), h(".popup-search-box", ".searchBoxToggler", ".searchClose", "show"), h(".sidemenu-cart", ".sideMenuToggler", ".sideMenuCls", "show"), h(".sidemenu-info", ".sideMenuInfo", ".sideMenuCls", "show"), e(".popup-image").magnificPopup({
            type: "image",
        ...
        TweenMax.to({}, .016, {
            repeat: -1,
            onRepeat: function() {
                m += (v - m) / 9, g += (b - g) / 9, TweenMax.set(f, {
                    css: {
                        left: m - 12,
                        top: g - 12
                    }
    ...
    window.addEventListener("pointermove", e => {
        ...
        e(this).each((function() {
            var a, s, i, o, r, l = e(this);
            a = Math.floor(l.height() / 2), s = l.attr(t), i = l.attr(n), o = T(e(i).css("padding-top")), r = T(e(i).css("padding-bottom")), "top-half" === s ? (e(i).css("padding-bottom", r + a + "px"), l.css("margin-top", "-" + a + "px")) : "bottom-half" === s && (e(i).css("padding-top", o + a + "px"), l.css("margin-bottom", "-" + a + "px"))
        }))
    };
    ...
    e("[data-sec-pos]").length && e("[data-sec-pos]").imagesLoaded((function() {
        ...
        e(".load-more-btn").on("click", (function() {
            var n = e(this).find("i");
            n.addClass("fa-spin-pulse"), setTimeout((function() {
                n.removeClass("fa-spin-pulse")
            }), 1e3);
            var a = e(this);
            setTimeout((function() {
                var n = a.prev(".load-more-active");
                0 === n.length && (n = a.closest(".container").find(".load-more-active")), n.find(".filter-item.d-none, .accordion-card.d-none").removeClass("d-none");
                e(t).isotope({
                    filter: "*"
                })
            }), 700)
    ...
    if (e.fn.lettering = function(t) {
        ...
        }, e(".discount-anime").lettering(), e(".counter-number").counterUp({
            delay: 10,
            time: 1e3
        ...
        }, e(".shape-mockup2") && e(".shape-mockup2").shapeMockup2(), e(".progress-bar").waypoint((function() {
            e(".progress-bar").css({
            ...
            e(this).each((function() {
                ...
                var s = setInterval((function() {
                    ...
                    o < 10 && (o = "0" + o), r < 10 && (r = "0" + r), l < 10 && (l = "0" + l), c < 10 && (c = "0" + c), i < 0 ? (clearInterval(s), t.addClass("expired"), t.find(".message").css("display", "block")) : (a(".day").html(o), a(".hour").html(r), a(".minute").html(l), a(".seconds").html(c))
                }), 1e3)
            }))
        }, e(".counter-list").length && e(".counter-list").countdown(), e(document).on("mouseover", ".hover-item", (function() {
            e(this).addClass("item-active"), e(".hover-item").removeClass("item-active"), e(this).addClass("item-active")
        })), e(".hero-2").length > 0 && window.addEventListener("scroll", (function() {
        ...
        const e = [].slice.call(document.querySelectorAll(".overlay-direction .filter-item"), 0),
            ...
            a = (e, t) => {
                const {
                    ...
                    top: s,
                    left: i
                } = t.getBoundingClientRect(), o = e.pageX - (i + window.pageXOffset) - n / 2 * (n > a ? a / n : 1), r = e.pageY - (s + window.pageYOffset) - a / 2 * (a > n ? n / a : 1);
    ...
    e.fn.indicator = function() {
        e(this).each((function() {
            ...
            function o() {
                ...
                })), i.get(0).style.setProperty("--height-set", a), i.get(0).style.setProperty("--width-set", s), i.get(0).style.setProperty("--pos-y", o), i.get(0).style.setProperty("--pos-x", r)
            }
            n.length ? s = n : a.length && (s = a), s.on("click", (function(t) {
                t.preventDefault(), e(this).addClass("active"), e(this).siblings(".active").removeClass("active"), o()
            })), o(), e(window).on("resize", (function() {
                o()
            }))
        }))
    }, e(".indicator-active").length && e(".indicator-active").indicator(), e(".th-screen").length && e(window).on("scroll", (function() {
        ! function(t, n = 0) {
