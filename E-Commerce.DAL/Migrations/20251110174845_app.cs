        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SavedPhotos = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Birthday = table.Column<DateOnly>(type: "date", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    PasswordChanged = table.Column<DateTime>(type: "datetime2", nullable: false),
                    PassStrength = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PassDictionaryJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RecovEmail = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RecovPhone = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastLoginAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LoginHistory = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingTax = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FilterType = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "ApplicationUserPaymentCard",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserPaymentCard", x => new { x.CardsId, x.UsersId });
                    table.ForeignKey(
                        name: "FK_ApplicationUserPaymentCard_AspNetUsers_UsersId",
                        column: x => x.UsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationUserPaymentCard_PaymentCards_CardsId",
                        column: x => x.CardsId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReviewsId1 = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductReview", x => new { x.ReviewsId, x.ReviewsId1 });
                    table.ForeignKey(
                        name: "FK_ProductReview_Products_ReviewsId",
                        column: x => x.ReviewsId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductReview_Reviews_ReviewsId1",
                        column: x => x.ReviewsId1,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderPaymentCard", x => new { x.CardsId, x.OrdersId });
                    table.ForeignKey(
                        name: "FK_OrderPaymentCard_Orders_OrdersId",
                        column: x => x.OrdersId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderPaymentCard_PaymentCards_CardsId",
                        column: x => x.CardsId,
                        principalTable: "PaymentCards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Addresses_CityMaster_AreaId",
                        column: x => x.AreaId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserPaymentCard_UsersId",
                table: "ApplicationUserPaymentCard",
                column: "UsersId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderPaymentCard_OrdersId",
                table: "OrderPaymentCard",
                column: "OrdersId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductReview_ReviewsId1",
                table: "ProductReview",
                column: "ReviewsId1");
